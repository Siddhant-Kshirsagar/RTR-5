...
void display(void)
{
	...
	//sky background 
	glColor3f(0.0f, 150.0f / 255.0f, 1.0f);

	glVertex3f(-1.0f, 1.0f, 0.0f);

	glColor3f(228.0f/255.0f, 118.0f / 255.0f, 15.0f/255.0f);
	glVertex3f(-1.0f, 0.0f, 0.0f);

	glColor3f(1.0f, 195.0f / 255.0f, 0.0f);
	glVertex3f(1.0f, 0.0f, 0.0f);

	glColor3f(225.0f/255.0f, 225.0f / 255.0f, 225.0f / 255.0f);
	glVertex3f(1.0f, 1.0f, 0.0f);

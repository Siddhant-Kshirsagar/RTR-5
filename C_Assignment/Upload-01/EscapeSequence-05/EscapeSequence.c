...
int main(void)
{
	...
	printf("\'This Is A Single Quoted\' Done Using \\\' \\\'Escape Sequence \n\n");
	...
	printf("Demonstrating \102 Using \\ooo Escape Sequence \n\n");//102 Is The Octal Code For Letter 'B'. 'ooo' Is The Place-holder For 3 Digits Forming And Octal Number.

...
#define SGK_PI 3.1415926535897932

#define SGK_STRING "AstroMediComp RTR"

//If First Constant Is Not Assigned A Value, It Is Assumed To Be 0 i.e: 'SUNDAY' will be 0

//And The Rest Of The Constants Are Assigned Consecutive Integer Values From 0 onwards i.e:'MONDAY' will Be 1, 'TUESDAY' will Be and so on...
...
int main(void)
{
	...
	printf("SGK_PI Macro value =%.101f\n\n",SGK_PI);
	printf("Area Of Circle Of Radius 2 units = %f\n\n",(SGK_PI * 2.0f * 2.0f));//pi * r * r = area of cirlce of radius 'r'

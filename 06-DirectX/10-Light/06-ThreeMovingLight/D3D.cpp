...
void display(void)
{
	...
	if (bLightingEnable == TRUE)
	{
		...
		constantBuffer.LightAmbient[0] = XMVectorSet(light[0].ambient[0], light[0].ambient[1], light[0].ambient[2], 0.0);
		constantBuffer.LightDiffuse[0] = XMVectorSet(light[0].diffuse[0], light[0].diffuse[1], light[0].diffuse[2], 0.0);
		constantBuffer.LightSpecular[0] = XMVectorSet(light[0].specular[0], light[0].specular[1], light[0].specular[2], 0.0);
		constantBuffer.LightPosition[0] = XMVectorSet(light[0].position[0], light[0].position[1], light[0].position[2], light[0].position[3]);

		constantBuffer.LightAmbient[1] = XMVectorSet(light[1].ambient[0], light[1].ambient[1], light[1].ambient[2], 0.0);
		constantBuffer.LightDiffuse[1] = XMVectorSet(light[1].diffuse[0], light[1].diffuse[1], light[1].diffuse[2], 0.0);
		constantBuffer.LightSpecular[1] = XMVectorSet(light[1].specular[0], light[1].specular[1], light[1].specular[2], 0.0);
		constantBuffer.LightPosition[1] = XMVectorSet(light[1].position[0], light[1].position[1], light[1].position[2], light[1].position[3]);

		constantBuffer.LightAmbient[2] = XMVectorSet(light[2].ambient[0], light[2].ambient[1], light[2].ambient[2], 0.0);
		constantBuffer.LightDiffuse[2] = XMVectorSet(light[2].diffuse[0], light[2].diffuse[1], light[2].diffuse[2], 0.0);
		constantBuffer.LightSpecular[2] = XMVectorSet(light[2].specular[0], light[2].specular[1], light[2].specular[2], 0.0);
		constantBuffer.LightPosition[2] = XMVectorSet(light[2].position[0], light[2].position[1], light[2].position[2], light[2].position[3]);
...
void update(void)
{
	...
	if (bLightingEnable)
	{
		...
		lightAngleZero = lightAngleZero + 0.0002f;
		...
		lightAngleOne = lightAngleOne + 0.0002f;
		...
		lightAngleTwo = lightAngleTwo + 0.0002f;

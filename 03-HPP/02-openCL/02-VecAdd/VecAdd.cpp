...
int main(void)
{
	...
	// fillings values into host arrays
	...
	//set 0 based 1st argument i.e. device input1
	...
	// read back result from the device (i.e from device Output) into CPU variable (i.e. hostOutput)
	...
	if (bAccuracy == false)
	{
		sprintf(str, "Comparision of CPU and GPU Vector Addition is not within accuracy of 0.000001 at array index %d\n", breakValue);
	}
	else
	{

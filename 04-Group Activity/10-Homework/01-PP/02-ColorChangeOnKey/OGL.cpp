...
typedef struct COLOR MY_COLOR;

MY_COLOR shapeColor = { 1.0f,1.0f,1.0f };
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
	{
		...
		case 'f':
			...
			case 'r':
			{
				shapeColor.fRed = 1.0f;
				shapeColor.fGreen = 0.0f;
				shapeColor.fBlue = 0.0f;
			}
			break;
			...
			case 'g':
			{
				shapeColor.fRed = 0.0f;
				shapeColor.fGreen = 1.0f;
				shapeColor.fBlue = 0.0f;
			}
			break;
...
int initialize(void)
{
	...
	colorUniform = glGetUniformLocation(shaderProgramObject, "aColor");
	...
	{
		0.0f,1.0f,1.0f, // glColor3f() 1st  call for triangle
		1.0f,1.0f,0.0f, // glColor3f() 2nd  call for triangle
		1.0f,0.0f,1.0f // glColor3f() 3rd  call for triangle
	};
	...
	glVertexAttrib3f(AMC_ATTRIBUTE_COLOR, shapeColor.fRed, shapeColor.fGreen, shapeColor.fBlue);
	...
	// VBO(Vertex Buffer Object) for color
	glVertexAttrib3f(AMC_ATTRIBUTE_COLOR, shapeColor.fRed, shapeColor.fGreen, shapeColor.fBlue);
	//glGenBuffers(1, &vbo_colorSquare);

	////  bind with VBO( Vertex Buffer Object) for color
	//glBindBuffer(GL_ARRAY_BUFFER, vbo_colorSquare);

...
{
	//function declarations
	//1st param top x-axis of left most coordinate of triangle(data type float)
	//2nd param top y-axis of left most coordinate of triangle(data type float)
	//3rd param right most coordinate for rectangle pattern (length of pattern)(data type float)
	void RectUsingTriangle(float,float,float);

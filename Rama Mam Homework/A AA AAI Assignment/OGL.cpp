...
#pragma comment(lib,"OpenGL32.lib") // for OpenGL related funtion (begin withgl)
#pragma comment(lib,"glu32.lib") // for glu library related function (begin with glu)
	...
	void resize(int, int);
		...
		case WM_CHAR:
		{
			...
			case 'w':
				...
				{
					gfCameraVertical = gfCameraVertical + gfChangeFactor;
				}
				else
				{
					gfVertical = gfVertical + gfChangeFactor;
			...
			case 'a':
				...
				if (switchCameraToMovement)
				{
					gfCameraHorizontal = gfCameraHorizontal + gfChangeFactor;
				}
				else
				{
					gfHorizontal = gfHorizontal + gfChangeFactor;
				}
				break;
			case 'D':
			case 'd':
			...
			case 'z':
				...
				if (switchCameraToMovement)
				{
					gfCameraDepth = gfCameraDepth - gfChangeFactor;
				}
				else
				{

					gfDepth = gfDepth - gfChangeFactor;
				}
				break;
			case 'X': // Zoom Out
			case 'x':

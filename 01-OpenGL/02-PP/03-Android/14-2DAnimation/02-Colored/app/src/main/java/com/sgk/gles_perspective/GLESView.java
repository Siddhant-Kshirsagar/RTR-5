...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private int[] vbo_positionTriangle = new int[1];
    private int[] vbo_colorTriangle = new int[1];

    private int[] vao_square = new int[1];
    private int[] vbo_positionSquare = new int[1];
    private int[] vbo_colorSquare = new int[1];
    ...
    private void initialize(GL10 gl)
    {
        ...
        // position 
        GLES32.glGenBuffers(1,vbo_positionTriangle,0);
        
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_positionTriangle[0]);
        ...
        // color
        GLES32.glGenBuffers(1,vbo_colorTriangle,0);
        
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_colorTriangle[0]);
        ...
        GLES32.glGenBuffers(1,vbo_positionSquare,0);
        
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_positionSquare[0]);
    ...
    private void display()
    {
        ...
        GLES32.glUseProgram(shaderProgramObject);
         ...
         Matrix.rotateM(rotationMatrix,0,rAngle,1.0f,0.0f,0.0f);
    ...
    private void uninitialize()
    {
        ...
        // delete vbo 
        if(vbo_colorSquare[0]>0)
        {
            GLES32.glDeleteBuffers(1,vbo_colorSquare,0);
            vbo_colorSquare[0] = 0;
        }

        if(vbo_positionSquare[0]>0)
        {
            GLES32.glDeleteBuffers(1,vbo_positionSquare,0);
            vbo_positionSquare[0] = 0;
        }
        ...
        // delete vbo 
        if(vbo_colorTriangle[0]>0)
        {
            GLES32.glDeleteBuffers(1,vbo_colorTriangle,0);
            vbo_colorTriangle[0] = 0;
        }

        if(vbo_positionTriangle[0]>0)
        {
            GLES32.glDeleteBuffers(1,vbo_positionTriangle,0);
            vbo_positionTriangle[0] = 0;
        }

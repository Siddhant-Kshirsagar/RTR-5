package com.sgk.gles_tesselation_shader;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private int numberOfSegmentUniform = 0;
    private int numberOfStripUniform = 0;
    private int lineColorUniform = 0;

    private int uiNumberOfLineSegment;

    private boolean bLimitMax = false;
    ...
    private void initialize(GL10 gl)
    {
        ...
        final String tesselationControlShaderCode = String.format(
            "#version 320 es"+
            "\n"+
        ...
        GLES32.glShaderSource(tesselationControlShaderObject,tesselationControlShaderCode);
        ...
        if(shaderCompileStatus[0] == 0)
        {
            ...
            if(infoLogLength[0]>0)
            {
                ...
                if(infoLog!=null)
                {
                    System.out.println("SGK: tesselation Control shader compilation error log : "+infoLog);
        ...
        final String tesselationEvaluationShaderCode = String.format(
            "#version 320 es"+
            "\n"+
            "layout(isolines) in;" +
        ...
        GLES32.glShaderSource(tesselationEvaluationShaderObject,tesselationEvaluationShaderCode);
        ...
        if(shaderCompileStatus[0] == 0)
        {
            ...
            if(infoLogLength[0]>0)
            {
                ...
                if(infoLog!=null)
                {
                    System.out.println("SGK: tesselation evaluation shader compilation error log : "+infoLog);
        ...
        numberOfSegmentUniform = GLES32.glGetUniformLocation(shaderProgramObject, "uNumberOfSegment");
        numberOfStripUniform = GLES32.glGetUniformLocation(shaderProgramObject, "uNumberOfStrip");
        lineColorUniform = GLES32.glGetUniformLocation(shaderProgramObject, "uLineColor");

        // geometry / shape
        final float[] pointPosition = {
    ...
    private void display()
    {
        ...
        GLES32.glUniform1i(numberOfSegmentUniform, uiNumberOfLineSegment);
        GLES32.glUniform1i(numberOfStripUniform, 1);

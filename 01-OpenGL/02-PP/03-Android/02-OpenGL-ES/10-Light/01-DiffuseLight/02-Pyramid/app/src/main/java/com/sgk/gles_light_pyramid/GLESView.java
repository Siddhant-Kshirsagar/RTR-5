package com.sgk.gles_light_pyramid;
...
import com.sgk.gles_light_pyramid.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private int[] vbo_normalPyramid = new int[1];
    ...
    private void initialize(GL10 gl)
    {
	   ...
	   -0.894427f, 0.447214f,  0.000000f, // left-right
        ...
        // vbo normal
        GLES32.glGenBuffers(1,vbo_normalPyramid,0);
        
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_normalPyramid[0]);
    ...
    private void uninitialize()
    {
        ...
        // delete vbo_normalPyramid 
        if(vbo_normalPyramid[0]!=0)
        {
            GLES32.glDeleteBuffers(1,vbo_normalPyramid,0);
            vbo_normalPyramid[0] = 0;
        }

package com.sgk.gles_texture_checkerboard;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    {
        //variable declaration
        float []squarePosition = new float[12];
        ...
        // prepare vertices array for glBufferData
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(squarePosition.length * 4);
        ...
        // prepare vertices array for glBufferData
        byteBuffer = ByteBuffer.allocateDirect(squarePosition.length * 4);

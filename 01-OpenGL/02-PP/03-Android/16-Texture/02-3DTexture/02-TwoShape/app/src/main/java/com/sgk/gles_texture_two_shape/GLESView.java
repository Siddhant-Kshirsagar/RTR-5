package com.sgk.gles_texture_two_shape;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private int[] vbo_texcoordPyramid = new int[1];
    ...
    private void initialize(GL10 gl)
    {
        ...
        // vbo for texcoord
        GLES32.glGenBuffers(1,vbo_texcoordPyramid,0);
        
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_texcoordPyramid[0]);
        ...
        positionBuffer.put(pyramid_texCoord);
        positionBuffer.position(0);

        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,pyramid_texCoord.length * 4,positionBuffer,GLES32.GL_STATIC_DRAW);
    ...
    private void uninitialize()
    {
        ...
        // delete vbo_texcoordPyramid 
        if(vbo_texcoordPyramid[0]>0)
        {
            GLES32.glDeleteBuffers(1,vbo_texcoordPyramid,0);
            vbo_texcoordPyramid[0] = 0;
        }

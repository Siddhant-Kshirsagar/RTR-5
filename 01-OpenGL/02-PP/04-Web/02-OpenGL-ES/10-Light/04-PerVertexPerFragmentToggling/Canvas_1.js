...
function initialize() {
    ...
    // per vertex lighting
    {
        ...
        materialSpecularUniform_PV = gl.getUniformLocation(shaderProgramObject_PV, "uMaterialShineness");
    ...
    // per fragment lighting
    {
        ...
        materialSpecularUniform_PF = gl.getUniformLocation(shaderProgramObject_PF, "uMaterialShineness");
...
function display() {
    ...
    if(chooseShader == 1)
    {
        ...
        if (bLightingEnable == true)
        {
            ...
            gl.uniform1f(materialSpecularUniform_PV, materialShininess);
        }
        else
        {
    ...
    else if(chooseShader == 2)
    {
        ...
        if (bLightingEnable == true)
        {
            ...
            gl.uniform1f(materialSpecularUniform_PF, materialShininess);
        }
        else
        {

...
function resize() {
    ...
    if (canvas.width <= canvas.height) {
        mat4.ortho(orthographicProjectionMatrix,
            -100.0, 100.0,
            -100.0 * (parseFloat(canvas.height) / parseFloat(canvas.width)),
            100.0 * (parseFloat(canvas.height) / parseFloat(canvas.width)), -100.0, 100.0);
    }
    else {
        mat4.ortho(orthographicProjectionMatrix, (-100.0 * (parseFloat(canvas.width) / parseFloat(canvas.height))), (100.0 * (parseFloat(canvas.width) / parseFloat(canvas.height))),

...
-(void)display
{
    ...
    translationMatrix = vmath::translate(0.0f, 0.0f, -45.0f);
    ...
    [self pushMatrix:modelMatrix];
    {
        ...
        rotationMatrix = vmath::rotate((GLfloat)sholder, 0.0f, 0.0f, 1.0f);  // sholder rotation

        translationMatrix = mat4::identity();
        translationMatrix = vmath::translate(4.0f, 0.0f, 0.0f);
        ...
        [self pushMatrix:modelMatrix];
        {
            ...
            glUniform4f(colorUniform,0.8f,0.6f,0.4f,1.0f);
        ...
        translationMatrix = mat4::identity();
        translationMatrix = vmath::translate(1.25f, 0.0f, 0.0f);
        ...
        [self pushMatrix:modelMatrix];
        {
            ...
            translationMatrix = mat4::identity();
            translationMatrix = vmath::translate(1.45f, 0.0f, 0.0f);
        ...
        [self pushMatrix:modelMatrix];
        {
            ...
            translationMatrix = mat4::identity();
            translationMatrix = vmath::translate(2.0f, 0.45f, 0.0f);
        ...
        {
            translationMatrix = mat4::identity();
            translationMatrix = vmath::translate(2.1f, 0.05f, 0.0f);
        ...
        [self pushMatrix:modelMatrix];
        {
            ...
            translationMatrix = mat4::identity();
            translationMatrix = vmath::translate(2.0f, -0.4f, 0.0f);
        ...
        {
            rotationMatrix = mat4::identity();
            rotationMatrix = vmath::rotate(-22.0f, 0.0f, 0.0f, 1.0f);

            translationMatrix = mat4::identity();
            translationMatrix = vmath::translate(1.5f, -0.65f, 0.0f);
...
-(void) pushMatrix:(mat4) matrix
{
    ...
    {
        printf( "Error - Execeeded matrix stack limit\n");
        [self uninitialize];
        [self release];
        exit(0);
    }

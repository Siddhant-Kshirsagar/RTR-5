...
int initialize(void)
{
	...
	numOfIndex = sizeof(square_indices)/sizeof(square_indices[0]);
	fprintf(gpFILE, "Size of Index = %d \n", numOfIndex);
	...
	// step 19 : VBO(Vertex Buffer Object) for index
	glGenBuffers(1, &vbo_index);

	// step 20 : bind with VBO( Vertex Buffer Object) for index
...
void display(void)
{
	...
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_index);
	glDrawElements(GL_TRIANGLES, numOfIndex, GL_UNSIGNED_INT, 0);

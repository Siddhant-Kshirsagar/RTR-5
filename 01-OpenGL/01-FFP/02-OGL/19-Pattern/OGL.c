...
void display(void)
{
	...
	glViewport(0,windowHeight/2,(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();
	...
	glViewport(windowWidth/3,windowHeight/2,(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();
	...
	for(int x = -2; x<2; x++)
	{
		for(int y = 2; y>-2; y--)
		{
			...
			glColor3f(1.0f,1.0f,1.0f);
			glVertex3f((GLfloat)x+1,(GLfloat)y,0.0f);
			glVertex3f((GLfloat)x,(GLfloat)y,0.0f);
			glVertex3f((GLfloat)x,(GLfloat)y-1.0f,0.0f);
	...
	glViewport((windowWidth/3)+(windowWidth/3) ,windowHeight/2,(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();
	...
	for(int x = -2; x<2; x++)
	{
		for(int y = 2; y>-2; y--)
		{
			...
			glVertex3f((GLfloat)x,(GLfloat)y,0.0f);
			glVertex3f((GLfloat)x,(GLfloat)y-1.0f,0.0f);
			glVertex3f((GLfloat)x+1,(GLfloat)y-1.0f,0.0f);
	...
	glViewport(0 ,(windowHeight/12),(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();
	...
	glViewport((windowWidth/3) ,(windowHeight/12),(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();
	...
	for(int x = -2; x<=2; x++)
	{
		glVertex3f((GLfloat)-2,(GLfloat)2,0.0f);
		glVertex3f((GLfloat)-2,(GLfloat)-2,0.0f);

		glVertex3f((GLfloat)x,(GLfloat)-2,0.0f);
	}
	glEnd();
	...
	for(int y = 2; y>=-2; y--)
	{
		...
		glVertex3f((GLfloat)2,(GLfloat)y,0.0f);
	...
	glViewport((windowWidth/3)+(windowWidth/3) ,(windowHeight/12),(GLsizei)(windowWidth/2),(GLsizei)(windowHeight/2));
	glPushMatrix();

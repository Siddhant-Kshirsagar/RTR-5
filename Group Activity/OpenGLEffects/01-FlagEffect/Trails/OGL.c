...
BOOL gbfireEffect = FALSE;

GLfloat colorAlpha = 0.0f;
...
void display(void)
{
	...
	glTranslatef(0.0f, 0.0f, -18.0f);             // Translate 12 Units Into The Screen
			...
			if (gbfireEffect)
			{
				...
				for (x = 0; x < 44; x++)                // Loop Through The X Plane (44 Points)
				{
					for (y = 0; y < 44; y++)            // Loop Through The Y Plane (44 Points)
					{
						...
						glColor4f(1.0f, 0.0f, 0.0f, colorAlpha);
